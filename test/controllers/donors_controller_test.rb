...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference("Donor.count") do
      post donors_url, params: { donor: { bio: @donor.bio, email: @donor.email, name: @donor.name, password: "secret", password_confirmation: "secret", type: @donor.type } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { bio: @donor.bio, email: @donor.email, name: @donor.name, password: "secret", password_confirmation: "secret", type: @donor.type } }
